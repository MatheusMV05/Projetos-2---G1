...
if NOT_PROD:
    ...
    SECRET_KEY = 'django-insecure-*62m6&j^rz(vs%wt-#^+1l%elwg$x%*hw0bcdl#tfd8u)&ika6'
    ALLOWED_HOSTS = []
    DATABASES = {
        'default': {
...
WSGI_APPLICATION = 'g1_agro_app.wsgi.application'
